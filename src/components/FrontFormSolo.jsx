      ...
      <div className="flex justify-center mx-1">
        <form
          ...
          noValidate>
            ...
            <p className="text-[1.5rem] font-bold pb-1">Greg Luce Music</p>
            <p className="text-[1rem] font-bold pb-3">Email contact</p>
              Included with this is the oppotunity to get a <span className="font-bold">20%</span> discount on your first event. Thanks! We will talk soon.
            </div>
            ...
            <div style={{ position: "absolute", left: "-5000px" }} aria-hidden="true">
              <input type="text" name="b_93a75b530a80d657cb9b80df0_7af118c516" tabIndex="-1" value="" />
                ...
                <input
                  className="border-solid border-2 border-gray-600 p-[7px] m-1 rounded rounded-2 text-[1rem] button font-bold bg-gradient-to-tr from-red-400/80 to-yellow-300/80"
                  type="submit"
                  value="GET DISCOUNT"
                  name="get discount"
                />
