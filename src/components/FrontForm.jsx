  ...
  return (
    <div className="absolute h-[40%] w-[95%] text-[0.625rem] bottom-0 text-white">
      <div className="flex justify-center mx-1">
        <form
          className="w-[100%] max-w-[350px] tablet:max-w-[475px] h-[150px] bg-gray-800/30 border-solid border-2 border-gray-700 p-2 flex flex-col items-center justify-center validate"
          ref={formRef}
          ...
          noValidate>
            ...
            <div className="border-solid border-2 border-gray-600 rounded rounded-5 px-0 mx-1">
                    <input
                      className="bg-gray-500/0 py-2 text-[0.75rem] smallMobile:px-3 mobile:px-4 tablet:text-[1rem]"
                      type="text"
                      name="FNAME"
