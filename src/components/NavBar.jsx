...
const NavBar = () => {
    ...
    return(
        <div className="navbar relative h-[100px] smallMobile:h-[115px] tablet:h-[140px]">
            <div className="h-[2.5rem] absolute top-0 w-[100%] bg-blue-900 tablet:h-[3rem]">
                <p className="text-blue-100 absolute right-0 p-2 pr-[20px] tablet:text-[1.25rem] tablet:top-[3px] tablet:pr-[15px]z-10"><a href="tel:8174870886">817.487.0886</a></p>
            </div>

            {
            nav ? (
            <div>
            <AiOutlineClose onClick={handleNav} className="text-3xl absolute tablet:hidden z-[99] top-[3.75rem] right-5" />
            ...
            (
                <div>
                    <AiOutlineMenu onClick={handleNav} className="text-3xl absolute top-[3.5rem] tablet:hidden z-[99] smallMobile:top-[3.75rem] right-5" />
                </div>
            )
        }
